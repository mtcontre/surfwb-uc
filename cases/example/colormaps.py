...
geo_land = make_colormap({0.0:dark_green,
                                          0.3:green,
                                          0.7:light_green,
                                          1.0:tan})
                          
geo_bathy = make_colormap({0:brown,
                                           0.2:tan,
                                           0.4:dark_green,
                                           0.6:dark_green,
                                           0.8:green,
                                           1.0:light_green})                         
geo_water = make_colormap({0:blue,0.5:blue_green, 1.0:red})

nada = make_colormap({0:white,0.5:white,1:white})
