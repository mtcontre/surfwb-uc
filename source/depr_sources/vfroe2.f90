...
real (kind=8), dimension(2),intent(in):: epR, epL
! implicit none
kappa=10e-7
!L es menos
!R es mas
...
print*,it, i,j,x_global(i-2,j-2),y_global(i-2, j-2)

200	print*,'breakpoint'
