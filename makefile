...
.SUFFIXES: .f90 .o 
objects=  MODULES.o main2.o init.o input_control.o input_bound.o input_friction.o \
	readGA.o readIO.o input_geom.o  input_ic.o init_TS.o decomp_2d.o metrics.o Angulos.o \
	cfl_celerities.o outputmat.o outputgauges.o massbalance.o tstep.o solver.o \
