...
implicit none
real (kind=8):: C,t,dt,Fr2,epA, hR, uR,vR, epR, epxR,epyR, RR,dep, zepR, epxA,epyA,epxA2,epyA2,zepA,tauR,Rmenos,hA,zmin,uA,vA, Rmas,RmenosU,U1, alfa,a1,a2,a3,a4,K,qp,U1u,uU,vU,hU, JacA, cero, us, vs, hs
...
!Fija una altura afuera del dominio en el borde 0, flujo unidireccional v=0.0
implicit none
real (kind=8):: C,t,dt,Fr2,epA, hL, uL,vL, epL, epxL,epyL, RL,dep, zepL, epxA,epyA,epxA2,epyA2,zepA,tauL,Rmenos, qb,hA,zmin,uA,vA, Rmas,RmasU,U1, alfa, AT,QT,uT,a1,a2,a3,a4,K,qp,U1u,uU,vU,hU, Upar,UparL, UparR, JacA, cero
